...
const { gadgetUploads, gadgetUploads2 } = require('../middleware/ImageController/gadget');
...
const maxImage = 5;
var upload = gadgetUploads.array('gadgetImages', maxImage)
var upload2 = gadgetUploads2.array('gadgetImages', maxImage)
...
router.put('/gadget/update/all/image',
    function (req, res) {
        upload2(req, res, function (err) {
            ...
            if (!req.files || req.files.length == 0) {
                ...
                const { gadgettype, brandName } = req.body;

                gadget.updateMany({ gadgettype, brandName }, {
                    gadgetImages: arrayOfImg
                })
                    .then((data) => {

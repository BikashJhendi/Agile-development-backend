...
const { cosmeticUploads, cosmeticUploads2 } = require('../middleware/ImageController/cosmetic');
const multer = require('multer');
// const fileupload = require('../middleware/fileupload.js');

const maxImage = 5;
var upload = cosmeticUploads.array('cosmeticImages', maxImage)
var upload2 = cosmeticUploads2.array('cosmeticImages', maxImage)
...
router.put('/cosmetic/update/all/image',
    function (req, res) {
